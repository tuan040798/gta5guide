    ...
    private void addMenuItemsFromJson() {
        try {
            ...
            for (int i = 0; i < menuItemsJsonArray.length(); ++i) {
                ...
                String summary = menuItemObject.getString("summary");
                String data = menuItemObject.getString("data");

                MenuItem menuItem = new MenuItem(menuItemName, menuItemImageName, summary, data);
